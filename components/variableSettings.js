...
export const Clim_Ranges = Object.freeze({
  ...
  // CMIP6-only metrics
  'pr_gev-20yr': { max: 300, min: 0 },
  'pr_gev-50yr': { max: 300, min: 0 },
  'pr_gev-100yr': { max: 300, min: 0 },
  'dif_pr_gev-20yr': { max: 100, min: -100 },
  'dif_pr_gev-50yr': { max: 100, min: -100 },
  'dif_pr_gev-100yr': { max: 100, min: -100 },
  djf_t_iav: { max: 10, min: 0 },
  mam_t_iav: { max: 10, min: 0 },
  jja_t_iav: { max: 10, min: 0 },
  son_t_iav: { max: 10, min: 0 },
  ann_t_iav: { max: 10, min: 0 },
  dif_djf_t_iav: { max: 4, min: -4 },
  dif_mam_t_iav: { max: 4, min: -4 },
  dif_jja_t_iav: { max: 4, min: -4 },
  dif_son_t_iav: { max: 4, min: -4 },
  dif_ann_t_iav: { max: 4, min: -4 },
  djf_p_iav: { max: 100, min: 0 },
  mam_p_iav: { max: 100, min: 0 },
  jja_p_iav: { max: 100, min: 0 },
  son_p_iav: { max: 100, min: 0 },
  ann_p_iav: { max: 500, min: 0 },
  dif_djf_p_iav: { max: 60, min: -60 },
  dif_mam_p_iav: { max: 60, min: -60 },
  dif_jja_p_iav: { max: 60, min: -60 },
  dif_son_p_iav: { max: 60, min: -60 },
  dif_ann_p_iav: { max: 200, min: -200 },
  ann_snow_iav: { max: 100, min: 0 },
  dif_ann_snow_iav: { max: 50, min: -50 },
  wet_day_frac: { max: 1, min: 0 },
  dif_wet_day_frac: { max: 0.5, min: -0.5 },
