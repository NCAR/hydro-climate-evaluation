...
const Meta = ({ title, description, card, url }) => {
  ...
  const titleProp = title || 'NSF NCAR'
  const descriptionProp =
    description ||
    'Improving the transparency and scientific integrity of climate solutions with open data and tools.'
  const cardProp = card || 'https://ncar.ucar.edu/profiles/custom/ncar_ucar_umbrella/themes/custom/koru/libraries/koru-base/img/app-favicons/ncar/favicon.ico'
  const urlProp = url || 'https://ral.ucar.edu/solutions/products/intermediate-complexity-atmospheric-research-icar'
  const ncarFavIconICO = 'https://ncar.ucar.edu/profiles/custom/ncar_ucar_umbrella/themes/custom/koru/libraries/koru-base/img/app-favicons/ncar/favicon.ico'
