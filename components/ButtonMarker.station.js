...
import WashingtonLinks from "./WashingtonLinks";
import WashingtonText from "./WashingtonText";
...
export default function ButtonMarker({
  ...
  useEffect(() => {
    ...
    const createPopup = () => {
      ...
      if (site === "Joint Base Lewis–McChord, WA") {
        root = createRoot(box);
        root.render(
          <div>
            <WashingtonStations height="200px" />
            <WashingtonText />
            <WashingtonLinks />
          </div>
        );
